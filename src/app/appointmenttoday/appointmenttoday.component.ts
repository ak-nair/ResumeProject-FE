...
@Component({
  selector: 'app-appointmenttoday',
  templateUrl: './appointmenttoday.component.html',
  styleUrls: ['./appointmenttoday.component.scss']
})
...
Get_Appointment_List()
{
  ...
  this.AppointmentlistService.Get_AppointmentHistory().subscribe(Rows =>       
  {
